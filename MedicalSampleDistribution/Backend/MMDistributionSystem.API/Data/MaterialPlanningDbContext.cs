...
namespace MMDistributionSystem.API.Data;

public partial class MaterialPlanningDbContext : DbContext
{
    public MaterialPlanningDbContext()
    {
    }

    public MaterialPlanningDbContext(DbContextOptions<MaterialPlanningDbContext> options)
        : base(options)
    {
    }
    ...
    public virtual DbSet<TemporalTablePepe> TemporalTablePepes { get; set; }
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        if (!optionsBuilder.IsConfigured)
        {
            ...
            optionsBuilder.UseSqlServer("Server=Solsrv20.solutica,1684;Database=MaterialPlanningSystemProd;User Id=desa;Password=q1w2e3R4$;TrustServerCertificate=True;Encrypt=False;");
        }
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TemporalTablePepe>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("temporalTablePepe");

            entity.Property(e => e.CantXcriterioSegmentado).HasColumnName("cantXCriterioSegmentado");
            entity.Property(e => e.CantdifPackJefe).HasColumnName("cantdifPackJefe");
            entity.Property(e => e.Isfeje).HasColumnName("isfeje");
